 ...
 *        ie. deletes an entry by making the first character of his key NULL.
 *
 * @param filename (const char*) the path to the CKVS database to open
 * @param key      (const char*) the key of the entry to create
 * @param pwd      (const char*) the password of the entry to create
...
//=======================================================================================
/**
 * @brief Create a new database by writing a fresh headers and emptry entries in the new file denoted
 *        by filename.
 *
 * @param filename (const char*) the name to the CKVS database to open
 *
 * @return int, an error code
 */
int ckvs_local_create(const char *filename, int optargc, char** optargv);

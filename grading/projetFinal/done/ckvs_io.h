 ...
 *
 * @see more precise documentation in ckvs_io.c
 */
...
//=======================================================================================
/**
 * @brief Update one entry on the ckvs file (database)
 *
 * @param ckvs  (CKVS_t *) the database to update
 * @param idx   (uint32_t) the index of the entry that need to be updated
 *
 * @return (int), error code
 */
...
//=======================================================================================
/**
 * @note Week 14 (extension) : create a new database, asking the user for headers parameters
 *
 * @param name  (const char *) the name of the new database.
 *
 * @return (int), error code
 */

...
/**
 * @Note  Addendum for week_04, stay in this header even after the week_05 refactoring.
 *
 * @date  18/03/2022
 * @brief Check multiples properties that a header must fulfill
 *
 * @param  header (struct ckvs_header*) the header to be checked
 *
 * @return (int) ERROR_CHECK (-1)  if a header does not fulfill one property,
 *               ERR_NONE     (0)  if the header is correct.
 */
 ...
 *                             assumed to be large enough to store the
 *                             full representation (+ a null byte).
 *

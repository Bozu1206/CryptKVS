...
/**
 * @date  20/03/2022
 * @brief Initialize an entry by setting zeros to all fields.
 *
 *        Useful to have this function here to init an entry
 *          ex: function in ckvs_local.c
 *
 * @param entry (ckvs_entry_t *) the entry to be initialized.
 */
